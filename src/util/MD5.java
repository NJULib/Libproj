...
public class MD5 {
	...
	public static void main(String args[]) {
		...
		if (Array.getLength(args) == 0) {
			...
			System.out.println("MD5(\"abc\"):" + md5.getMD5ofStr("abcxccccccccccchiushgdxhgkxdjfgxdfhixjdhj4g84c98j4tx651g56fe四季桂igis是根深蒂固招股机制广电总局和izjhzjhf这中解放和idzjhozijhfzjhoijzdof好富家子哦哈附近走今后izhjiozdjfhiozj合法及欧洲及还在地方黄子佼合作将电话朱家坟和欧洲就会朱家坟和子偶就合资的积分"));
			System.out.println("MD5(\"abc\"):" + md5.getMD5ofStr("abcxccccccccccchiushgdxhgkxdjfgxdfhixjdhj4g84c98j4tx651g56fe3季桂igis是根深蒂固招股机制广电总局和izjhzjhf这中解放和idzjhozijhfzjhoijzdof好富家子哦哈附近走今后izhjiozdjfhiozj合法及欧洲及还在地方黄子佼合作将电话朱家坟和欧洲就会朱家坟和子偶就合资的积分"));
			System.out.println("MD5(\"message digest\"):"
					+ md5.getMD5ofStr("message digest"));
			System.out.println("MD5(\"abcdefghijklmnopqrstuvwxyz\"):"
					+ md5.getMD5ofStr("abcdefghijklmnopqrstuvwxyz"));
			System.out.println("MD5(\"8888\"):" + md5.getMD5ofStr("8888"));
